    ...
    <div className='flex flex-col gap-2 max-w-[400px] w-full mx-auto'>
       {!translating && ( <div className='flex flex-col gap-1 mb-4'>
            ...
            <div className="flex items-stretch gap-2 sm:gap-4">
                <select value={toLanguage} className='flex-1 outline-none bg-white focus:outline-none border-solid border-transparent hover:border-blue-300 duration-200 p-2  rounded' onChange={(e) =>setToLanguage( e.target.value)}>
